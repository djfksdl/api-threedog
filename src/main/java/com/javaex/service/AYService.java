...
public class AYService {
	...
	// 반려견수정
	public String exePetUpdate(DogVo dogVo) {
		System.out.println("AYService.exePetUpdate()");
	...
	// 내가 쓴 후기
	public ReviewVo exeGetReview(int uNo) {
		System.out.println("AYService.exeGetReview");

		ReviewVo reviewVo = ayDao.getReview(uNo);
