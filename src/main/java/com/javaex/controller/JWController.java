...
public class JWController {
	...
	public JsonResult selectReserveList() {
		System.out.println("JWController.list");

		List<ReserveVo> reserveList = jwService.getReserveList();
    ...
    public JsonResult updateReserve(@RequestBody ReserveVo reserveVo) {
        System.out.println("JWController.updateReserve");
        
        System.out.println(reserveVo);
        
        jwService.exeUpdateReserve(reserveVo);
